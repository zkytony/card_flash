...
class Activity
{
  ...
  // activities happening in the period for a user
  ...
  // returns an array of more specific data, but it translates the date
  // into 3 values: subject, action, object
  // Thus, the resulting array will have keys:
  // timeid => (
  //    'time', 'subject', 'action'. 'object', 'additional'
  //  )
  // contained;
